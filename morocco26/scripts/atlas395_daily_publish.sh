...
python morocco26/scripts/atlas395_daily.py build-edition --data-dir morocco26/web/data --editions-dir morocco26/web/editions --science-ref "$SCIENCE_REF" --release-manifest "$RELEASE_MANIFEST"
