...
WAVES=[A/'acquisition'/'2016_candidate_party_augmented_wave1.json',A/'acquisition'/'2016_candidate_party_augmented_wave2.json',A/'acquisition'/'2016_candidate_party_augmented_wave3.json']
